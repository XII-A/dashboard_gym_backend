...
export interface ApiCalorieCalorie extends Schema.CollectionType {
  ...
  attributes: {
    kcl: Attribute.Integer & Attribute.Required;
...
export interface ApiDietPlanDietPlan extends Schema.CollectionType {
